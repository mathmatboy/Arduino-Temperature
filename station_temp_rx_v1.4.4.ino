...
void loop() {
   ...
   */
    Serial.println("\n");
    Serial.print("Temperature interieur (oC): ");
   ...
   if( vw_get_message(buf, &buflen) )
      {
       ...
       for (i = 0; i < buflen; i++)
         { 
           lcd.write(buf[i]); 
           Serial.print("Temperature exterieur (oC): ");
           Serial.print(buf[i]);                    
         }
           lcd.write(4);
           lcd.print("C");
      ...
      Serial.print("TimeOut : En attente de reception de la temperature exterieur...");
         lcd.setCursor(0, 1);
         lcd.print("Pas reception...");
         delay(1000);
         lcd.clear();
      }
